...
public class DataBasePostgreSQL {
    ...
    public DataBasePostgreSQL(){
        String driver = SettingsDB.DRIVER.getValue();
        String url = SettingsDB.URL.getValue();
        String username = SettingsDB.USERNAME.getValue();
        String password = SettingsDB.PASSWORD.getValue();
    }
